                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-6 col-sm-12 text-center" style="margin-bottom: 20px;">
                                <div style="background: #f8f9fa; border: 1px solid #ccc; padding: 25px; border-radius: 10px; max-width: 100%; margin: 0 auto;">
                                    <h4 class="text-center" style="color: #dc3545; font-weight: bold;">SƠ ĐỒ PHÒNG MÁY</h4>
                                    <div class="sodo">
                                        <p id="khongcosodo" class="hidden text-center" style="font-size: 18px;">Chưa có sơ đồ phòng máy!</p>
                                        <div id="sodophongmay" style=" display: grid;grid-template-columns: repeat(6, 1fr);gap: 10px;margin-top: 20px;">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-12">
                                <div style="padding: 20px;">
                                    ...
                                    <div class="form-group autocomplete">
                                        ...
                                        <input id="phongSearch" required type="text" class="form-control" name="phongSearch" placeholder="Nhập tên phòng (VD: A201)">
                                    </div>
                                    <div class="row" style="margin-top: 15px;">
                                        <div class="col-xs-12 col-sm-4" style="margin-bottom: 10px;">
                                            <a class="btn btn-block btn-primary" data-toggle="modal" data-target="#addModalOld">
                                                <i class="fa fa-calendar"></i> Thêm lịch cũ
                                            </a>
                                        </div>
                                        <div class="col-xs-12 col-sm-4" style="margin-bottom: 10px;">
                                            <a class="btn btn-block btn-primary" data-toggle="modal" data-target="#addModalNew">
                                                <i class="fa fa-calendar-plus-o"></i> Thêm lịch sử dụng
                                            </a>
                                        </div>
                                        <div class="col-xs-12 col-sm-4" style="margin-bottom: 10px;">
                                            <a class="btn btn-block btn-primary" data-toggle="modal" data-target="#modalPrint">
